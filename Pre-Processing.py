...
if __name__ == "__main__":
    ...
    tfidf_vectorizer = TfidfVectorizer(tokenizer=lambda x: x.split(), ngram_range=(1,3))
    ...
    for train, test in cv.split(X,y):
        ...
        neg_imp_features = get_n_imp_features(pipeline.named_steps["classifier"], pipeline.named_steps["vectorizer"].get_feature_names(), n=10)[1]
        imps_b += list(neg_imp_features) if neg_imp_features is not None else []
